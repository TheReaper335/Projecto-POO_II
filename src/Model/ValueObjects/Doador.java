...
public class Doador {
    ...
    private float peso;
    private int contacto,contactoF, idade, numero, idNumero, indexResp1, indexResp2;
    ...
    public int getIndexResp1() {
        return indexResp1;}

    public void setIndexResp1(int indexResp1) {
        this.indexResp1 = indexResp1;}

    public int getIndexResp2() {
        return indexResp2;}

    public void setIndexResp2(int indexResp2) {
        this.indexResp2 = indexResp2;}
    ...
    public String gerarId(){
        ...
        idNumero = (dc.contarDoador() + 1);
        return id = "DD-" + idNumero;}
